...
#define apparatus
A = mw.Apparatus()
A.add(test_comp, varian_pump_1, mw.Tube("5 in", "1/16 in", "2/16 in", "PVC"))
A.add(test_comp, varian_pump_2, mw.Tube("5 in", "1/16 in", "2/16 in", "PVC"))

start_time = timedelta(seconds=0)

P = mw.Protocol(A, duration="auto")
P.add(varian_pump, start=start_time, duration="15 seconds", rate='5 mL/min')
P.add(varian_pump2, start=start_time, duration="15 seconds", rate='5 mL/min')
